...
@ref(tab:clc\_perc) below shows the structure of the data frame where
each station identified by an ID has the percentage of cover for each
class.

\textbackslash{}begin\{table\}

\textbackslash{}caption\{(\#tab:clc\_perc)Distribution (\%) of land
covers around physical stations\} \centering
