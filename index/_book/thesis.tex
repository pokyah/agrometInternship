...
internship and Jean-Pierre Huart for his kindness and benevolence.

I also would like to thank the Youkou team for its good mood and
...
The following code chunk shows an example of the structure of the code
using mlr to define learners, resampling strategy and run benchmark.
...
are integrated to visualize results and learning algoriths can be
compared and ranked.
