...
\address{Rue de Liroux 9, 5930 Gembloux, Belgique}
...
\Preface{
This is where goes my preface veoivhreovhnre rebojuhreoubhgr broibhu
brebrihbr rb
}
...
\KeywordTok{library}\NormalTok{(thesisdown)}
\KeywordTok{Sys.setenv}\NormalTok{(}\DataTypeTok{RSTUDIO_PDFLATEX =} \StringTok{"latexmk"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
