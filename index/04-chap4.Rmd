...
```{r mlr, echo=FALSE, fig.cap="mlr workflow", out.width="60%", fig.align='center'}
...
The following code chunk shows an example of the structure of the code using mlr to define learners, resampling strategy and run benchmark.

\clearpage

```{r exmlr, eval=FALSE, fig.cap="Structure of the code using mlr package", out.width="100%"}
# define learners
...
The package includes several ways to analyze benchmark results. Plots are integrated to visualize results and learning algoriths can be compared and ranked.
