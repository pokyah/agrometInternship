...
```{r meanerror, echo=FALSE, fig.cap="Errors (RMSE and MAE) of methods", out.width="90%", fig.align='center'}
...
```{r barchart, echo=FALSE, fig.cap="Comparison of methods by rank", out.width="90%", fig.align='center'}
